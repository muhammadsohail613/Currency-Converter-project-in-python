...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Create title label
        self.title_label = Label(self, text='Currency Converter', bg='#00ffff', fg='magenta', font=('franklin gothic medium', 20), relief='sunken')
        self.title_label.place(x=200, y=35, anchor='center')

        # Create date label
        self.date_label = Label(self, text=f'{dt.datetime.now():%A, %B %d, %Y}', bg='#00ffff', fg='red', font=('calibri', 10))
        self.date_label.place(x=0, y=400, anchor='sw')

        # Create version label
        self.version_label = Label(self, text='v1.0', bg='#00ffff', fg='magenta', font=('calibri', 10))
        self.version_label.place(x=400, y=400, anchor='se')

        # Create amount label
        self.amount_label = Label(self, text='Input Amount: ', bg='#00ffff', fg='magenta', font=('franklin gothic book', 15))
        ...
        # Create 'from' label
        self.base_currency_label = Label(self, text='From: ', bg='#00ffff', fg='magenta', font=('franklin gothic book', 15))
        self.base_currency_label.place(x=200, y=140, anchor='center')

        # Create 'to' label
        self.destination_currency_label = Label(self, text='To: ', bg='#00ffff', fg='magenta', font=('franklin gothic book', 15))
        ...
        self.convert_button = Button(self, text='Convert', bg='red', fg='white', command=self.processed)
        ...
        self.final_result = Label(self, text='', bg='orange', fg='white', font=('calibri', 12), relief='sunken', width=40)
